...
DefinitionBlock("", "SSDT", 2, "hack", "batt", 0)
{
    ...
    External(_SB.PCI0.LPCB.EC.ACAP, MethodObj)
    External(CHGS, MethodObj)
    External(BLLO, IntObj)
    External(_SB.PCI0.LPCB.EC.EB0S, FieldUnitObj)
    External(_SB.PCI0.BAT0.PUNT, IntObj)
    External(_SB.PCI0.LPCB.EC.B0DV, FieldUnitObj)
    External(_SB.PCI0.BAT0.LFCC, IntObj)
    External(MBLF, IntObj)
    External(_SB.PCI0.BAT0.PBST, PkgObj)
    External(_SB.PCI0.LPCB.EC.BATP, MethodObj)
    External(_SB.PCI0.BAT0.NBIX, PkgObj)
    External(_SB.PCI0.LPCB.EC.GBTT, MethodObj)
    ...
    External(_SB.PCI0.LPCB.EC.PRTC, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.SBBY, IntObj)
    External(_SB.PCI0.LPCB.EC.ADDR, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.CMDB, FieldUnitObj)
    ...
    External(_SB.PCI0.LPCB.EC.PRT2, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.DAT1, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.ADD2, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.CMD2, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.BCN2, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.DA20, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.DA21, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.SSTS, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.SST2, FieldUnitObj)
